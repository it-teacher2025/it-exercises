...
const itemsData = [
    { id: "categ11",  label: "==",   category: "category-1" },
    { id: "categ12",  label: ">",   category: "category-1" },
    { id: "categ13",  label: "<",   category: "category-1" },
    { id: "categ14",  label: ">=",   category: "category-1" },
    { id: "categ15",  label: "<=",   category: "category-1" },
    { id: "categ16",  label: "!=",   category: "category-1" },

    { id: "categ21",  label: "not",   category: "category-2" },
    { id: "categ22",  label: "and",   category: "category-2" },
    { id: "categ23",  label: "or",   category: "category-2" },
  ];
