/**
   ...
   */
const steps = [
    { text: 'A = [2, 0, 2, 6, 0]', correctIndex: 0 },
    { text: 'product = 1', correctIndex: 1 },
    { text: 'for i in range(len(A)):', correctIndex: 2 },
    { text: '&#160;&#160;&#160;&#160;if A[i] != 0:', correctIndex: 3 },
    { text: '&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;product *= A[i]', correctIndex: 4 },
    { text: 'print("Добуток ненульових чисел =", product)', correctIndex: 5 },
  ];
