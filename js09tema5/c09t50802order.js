...
const steps = [
    ...
    { text: 'k = 0', correctIndex: 1 },
    { text: 'for i in A:', correctIndex: 2 },
    { text: '&#160;&#160;&#160;&#160;if i > 0:', correctIndex: 3 },
    { text: '&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;k += 1', correctIndex: 4 },
    { text: 'print("Кількість додатних елементів =", k)', correctIndex: 5 },
  ];
