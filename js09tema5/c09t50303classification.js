...
const itemsData = [
    { id: "categ11",  label: "Масив[i]",   category: "category-1" },

    { id: "categ21",  label: "Масив[m:n]",   category: "category-2" },

    { id: "categ31",  label: "Масив[:n]",   category: "category-3" },

    { id: "categ41",  label: "Масив[m:]",   category: "category-4" },

    { id: "categ51",  label: "Масив[:]",   category: "category-5" },
  ];
