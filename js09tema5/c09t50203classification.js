...
const itemsData = [
    { id: "categ11",  label: "2 > 1",   category: "category-1" },
    { id: "categ12",  label: "1 < 2",   category: "category-1" },
    { id: "categ13",  label: "2 >= 2",   category: "category-1" },
    { id: "categ14",  label: "2 <= 2",   category: "category-1" },
    { id: "categ15",  label: "2 == 2",   category: "category-1" },
    { id: "categ16",  label: "2 != 1",   category: "category-1" },

    { id: "categ21",  label: "1 > 2",   category: "category-2" },
    { id: "categ22",  label: "2 < 1",   category: "category-2" },
    { id: "categ23",  label: "1 >= 2",   category: "category-2" },
    { id: "categ24",  label: "2 <= 1",   category: "category-2" },
    { id: "categ25",  label: "2 == 1",   category: "category-2" },
    { id: "categ26",  label: "2 != 2",   category: "category-2" },
  ];
