...
const steps = [
    ...
    { text: 'root.title("Інформатика")', correctIndex: 2 },
    { text: 'root.geometry("250x100")', correctIndex: 3 },
    { text: 'Label(root, text="Python").pack()', correctIndex: 4 },
    { text: 'Button(root, text="Урок").pack()', correctIndex: 5 },
    { text: 'root.mainloop()', correctIndex: 6 },
  ];
