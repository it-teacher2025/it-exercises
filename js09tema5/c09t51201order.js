/**
   ...
   */
const steps = [
    { text: 'from tkinter import *', correctIndex: 0 },
    { text: 'root = Tk()', correctIndex: 1 },
    { text: 'my_list = Listbox(root, width=40, selectmode=EXTENDED)', correctIndex: 2 },
    { text: 'my_language = ["Python", "Lazarus", "Php", "Java", "JavaScript"]', correctIndex: 3 },
    { text: 'for a in my_language:', correctIndex: 4 },
    { text: '&#160;&#160;&#160;&#160;my_list.insert(END, a)', correctIndex: 5 },
    { text: 'my_list.pack()', correctIndex: 6 },
    { text: 'root.mainloop()', correctIndex: 7 },
  ];
