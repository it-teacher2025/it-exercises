...
const itemsData = [
    { id: "categ11",  label: "len(список)",   category: "category-1" },

    { id: "categ21",  label: "max(список)",   category: "category-2" },

    { id: "categ31",  label: "min(список)",   category: "category-3" },

    { id: "categ41",  label: "sum(список)",   category: "category-4" },

    { id: "categ51",  label: "del(список[n])",   category: "category-5" },

    { id: "categ61",  label: "list(рядок)",   category: "category-6" }
  ];
