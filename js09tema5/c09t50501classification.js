...
const itemsData = [
    { id: "categ11",  label: ".insert(i, x)",   category: "category-1" },

    { id: "categ21",  label: ".remove(x)",   category: "category-2" },

    { id: "categ31",  label: ".index(x)",   category: "category-3" },

    { id: "categ41",  label: ".count(x)",   category: "category-4" },

    { id: "categ51",  label: ".sort()",   category: "category-5" },

    { id: "categ61",  label: ".reverse()",   category: "category-6" },

    { id: "categ71",  label: ".append(x)",   category: "category-7" },
  ];
