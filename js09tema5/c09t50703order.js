/**
   ...
   */
const steps = [
    { text: 'A = [2, 5, 14, 62, -5]', correctIndex: 0 },
    { text: 'for i in range(len(A)):', correctIndex: 1 },
    { text: '&#160;&#160;&#160;&#160;if A[i] < 0:', correctIndex: 2 },
    { text: '&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;A[i] *= 2', correctIndex: 3 },
    { text: 'print(A)', correctIndex: 4 },
  ];
