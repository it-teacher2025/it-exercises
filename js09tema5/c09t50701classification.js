...
const itemsData = [
    { id: "categ11",  label: "Послідовно звертатися до елементів за їх індексами. Застосовується, коли потрібно змінювати значення елементів списку.",   category: "category-1" },

    { id: "categ21",  label: "Перебрати всі наявні в списку елементи. Застосовується, коли не потрібно змінювати значення елементів списку.",   category: "category-2" },
  ];
