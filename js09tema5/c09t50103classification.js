...
const itemsData = [
    { id: "categ11",  label: "120",   category: "category-1" },
    { id: "categ12",  label: "-120",   category: "category-1" },
    { id: "categ13",  label: "0",   category: "category-1" },

    { id: "categ21",  label: "120.5",   category: "category-2" },
    { id: "categ22",  label: "-120.5",   category: "category-2" },
    { id: "categ23",  label: "0.5",   category: "category-2" },

    { id: "categ31",  label: '"Інформатика"',   category: "category-3" },
    { id: "categ32",  label: '"Hello, World!"',   category: "category-3" },
    { id: "categ33",  label: '"Python"',   category: "category-3" },
  ];
