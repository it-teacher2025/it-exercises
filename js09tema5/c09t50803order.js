/**
   ...
   */
const steps = [
    { text: 'A = [2, 0, 14, 62, -5]', correctIndex: 0 },
    { text: 'mx = A[0]', correctIndex: 1 },
    { text: 'for i in range(1, len(A)):', correctIndex: 2 },
    { text: '&#160;&#160;&#160;&#160;if A[i] > mx:', correctIndex: 3 },
    { text: '&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;mx = A[i]', correctIndex: 4 },
    { text: 'print("Максимальний елемент має значення", mx)', correctIndex: 5 },
  ];
