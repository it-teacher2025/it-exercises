...
const itemsData = [
    ...
    { id: "categ21",  label: "-",   category: "category-2" },

    { id: "categ31",  label: "*",   category: "category-3" },

    { id: "categ41",  label: "**",   category: "category-4" },

    { id: "categ51",  label: "/",   category: "category-5" },

    { id: "categ61",  label: "//",   category: "category-6" },

    { id: "categ71",  label: "%",   category: "category-7" },
  ];
