...
const itemsData = [
    { id: "categ11",  label: "6",   category: "category-1" },

    { id: "categ21",  label: "31",   category: "category-2" },

    { id: "categ31",  label: "-5",   category: "category-3" },

    { id: "categ41",  label: "44",   category: "category-4" },

    { id: "categ51",  label: "[1, 5, 5, 31, -5]",   category: "category-5" },

    { id: "categ61",  label: "['2', ' ', ' ', '5', '6', ' ', ' ', '1', '2', ' ', ' ', '5']",   category: "category-6" },
  ];
