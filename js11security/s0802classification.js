...
const itemsData = [
    { id: "categ11",  label: "Зашифрування",   category: "category-1" },

    { id: "categ21",  label: "Розшифрування",   category: "category-2" },

    { id: "categ31",  label: "Шифрування",   category: "category-3" },

    { id: "categ41",  label: "Криптографічний алгоритм, або шифр",   category: "category-4" },
  ];
