/**
   ...
   */
const steps = [
    { text: "Етап полягає в пошуку передумов для здійснення атаки.", correctIndex: 0 },
    { text: "Пошук вразливостей, використання яких робить можливим реалізацію атаки.", correctIndex: 1 },
    { text: "Атака завершується, «заметено» сліди і т.д.", correctIndex: 2 },
  ];
