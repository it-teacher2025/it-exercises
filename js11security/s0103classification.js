...
const itemsData = [
    { id: "categ11",  label: "Текстові ІТ",   category: "category-1" },
    { id: "categ12",  label: "Графічні ІТ",   category: "category-1" },
    { id: "categ13",  label: "Числові ІТ",   category: "category-1" },
    { id: "categ14",  label: "Мультимедійні ІТ",   category: "category-1" },

    { id: "categ21",  label: "ІТ передавання даних",   category: "category-2" },
    { id: "categ22",  label: "ІТ опрацювання даних",   category: "category-2" },
    { id: "categ23",  label: "ІТ зберігання даних",   category: "category-2" },

    { id: "categ31",  label: "ІТ пошуку даних",   category: "category-3" },
    { id: "categ32",  label: "ІТ стиснення даних",   category: "category-3" },
    { id: "categ33",  label: "ІТ кодування даних",   category: "category-3" },
    { id: "categ34",  label: "ІТ захисту даних",   category: "category-3" },
  ];
