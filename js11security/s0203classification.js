...
const itemsData = [
    { id: "categ11",  label: "Зумисне пошкодження чи викрадення даних хакерами",   category: "category-1" },
    { id: "categ12",  label: "Пошкодження даних внаслідок необережних дій",   category: "category-1" },

    { id: "categ21",  label: "Комп’ютерні віруси",   category: "category-2" },
    { id: "categ22",  label: "Спам",   category: "category-2" },
    { id: "categ23",  label: "Фішинг",   category: "category-2" },
  ];
