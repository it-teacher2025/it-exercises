/**
   ...
   */
const steps = [
    { text: "Визначення цінності  об’єкта захисту інформації.", correctIndex: 0 },
    { text: "Аналіз потенційних дій зловмисників.", correctIndex: 1 },
    { text: "Оцінка надійності встановлених засобів захисту інформації на об’єкті.", correctIndex: 2 },
  ];
