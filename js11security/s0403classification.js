...
const itemsData = [
    { id: "categ11",  label: "Заражають виконувані файли й допоміжні програми",   category: "category-1" },

    { id: "categ21",  label: "Заражають завантажувальний сектор диска",   category: "category-2" },

    { id: "categ31",  label: "Заражають файли Word, Excel тощо, які підтримують роботу макросів (вбудованих програм)",   category: "category-3" },

    { id: "categ41",  label: " Розповсюджуються мережею",   category: "category-4" },
  ];
