...
const itemsData = [
    { id: "categ11",  label: "Файлові",   category: "category-1" },
    { id: "categ12",  label: "Завантажувальні",   category: "category-1" },
    { id: "categ13",  label: "Макровіруси",   category: "category-1" },
    { id: "categ14",  label: "Мережеві",   category: "category-1" },

    { id: "categ21",  label: "Звичайні",   category: "category-2" },
    { id: "categ22",  label: "Невидимі",   category: "category-2" },
    { id: "categ23",  label: "Поліморфні",   category: "category-2" },

    { id: "categ31",  label: "Безпечні",   category: "category-3" },
    { id: "categ32",  label: "Небезпечні",   category: "category-3" },
  ];
