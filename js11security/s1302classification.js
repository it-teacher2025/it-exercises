...
const itemsData = [
    { id: "categ11",  label: "Способ роботи системи mail-контент у розриві",   category: "category-1" },

    { id: "categ21",  label: "Способ роботи системи mail-контент у відгалуженні",   category: "category-2" },
  ];
