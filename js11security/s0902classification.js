...
const itemsData = [
    { id: "categ11",  label: "Статичні системи виявлення атак",   category: "category-1" },

    { id: "categ21",  label: "Динамічні системи виявлення атак",   category: "category-2" },

    { id: "categ31",  label: "Мережеві системи виявлення атак",   category: "category-3" },

    { id: "categ41",  label: "Хостові системи виявлення атак",   category: "category-4" },
  ];
