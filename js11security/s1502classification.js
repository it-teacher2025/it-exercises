...
const itemsData = [
    { id: "categ11",  label: "Файловий монітор (вартовий)",   category: "category-1" },

    { id: "categ21",  label: "Поведінковий аналізатор (інспектор)",   category: "category-2" },

    { id: "categ31",  label: "Поштовий фільтр",   category: "category-3" },

    { id: "categ41",  label: "USB-захист",   category: "category-4" },

    { id: "categ51",  label: "Евристичний аналізатор",   category: "category-5" },

    { id: "categ61",  label: "Мережевий екран (брандмауер)",   category: "category-6" },
    
    { id: "categ71",  label: "Антифішинг",   category: "category-7" },

    { id: "categ81",  label: "Антиспам",   category: "category-8" },

    { id: "categ91",  label: "Батьківський контроль",   category: "category-9" },

    { id: "categ101",  label: "Файл-шредер",   category: "category-10" },
  ];
