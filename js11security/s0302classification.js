...
const itemsData = [
    { id: "categ11",  label: "викликані впливом на інформаційне середовище об’єктивних фізичних процесів або стихійних природних явищ, що не залежать від волі людини",   category: "category-1" },

    { id: "categ21",  label: "помилки програмного забезпечення, персоналу, збої в роботі систем, відмови обчислювальної та комунікаційної техніки",   category: "category-2" },

    { id: "categ31",  label: "неправомірний доступ до інформації, розробка спеціального програмного забезпечення, використовуваного для здійснення неправомірного доступу, розробка та поширення вірусних програм і т.д.",   category: "category-3" },
  ];
