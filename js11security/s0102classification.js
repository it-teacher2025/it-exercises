...
const itemsData = [
    { id: "categ11",  label: "Інформацією вважають ті відомості, які для людини є новими і корисними",   category: "category-1" },

    { id: "categ21",  label: "Інформація є результатом відображення у свідомості людини картини реального світу",   category: "category-2" },

    { id: "categ31",  label: "За Законом України «Про інформацію» — це будь-які відомості та/або дані, що можуть бути збережені на матеріальних носіях або відображені в електронному вигляді",   category: "category-3" },
  ];
