...
const itemsData = [
    { id: "categ11",  label: "Модифікація (спотворення) інформації",   category: "category-1" },
    { id: "categ12",  label: "Заперечення дійсної інформації",   category: "category-1" },
    { id: "categ13",  label: "Нав'язування фальшивої інформації",   category: "category-1" },

    { id: "categ21",  label: "Блокування інформації",   category: "category-2" },
    { id: "categ22",  label: "Знищення інформації та засобів її обробки",   category: "category-2" },

    { id: "categ31",  label: "Несанкціонований доступ",   category: "category-3" },
    { id: "categ32",  label: "Утрата (ненавмисна втрата, витік) інформації",   category: "category-3" },
    { id: "categ33",  label: "Викрадення інформації, її розголошення",   category: "category-3" },
  ];
