...
const itemsData = [
    { id: "categ11",  label: "Не виконують шкідливих дій, крім свого поширення і дратівливих ефектів",   category: "category-1" },

    { id: "categ21",  label: "Виконують шкідливі дії, що призводять до пошкодження даних і програм",   category: "category-2" },
  ];
