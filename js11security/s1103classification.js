...
const itemsData = [
    { id: "categ11",  label: "Маршрутизатор",   category: "category-1" },

    { id: "categ21",  label: "Системи виявлення втручань",   category: "category-2" },

    { id: "categ31",  label: "Засоби аналізу захищеності",   category: "category-3" },

    { id: "categ41",  label: "Засоби створення віртуальних приватних мереж (VPN)",   category: "category-4" },

    { id: "categ51",  label: "Мережеві антивіруси",   category: "category-5" },
  ];
