...
const itemsData = [
    { id: "categ11",  label: "Брандмауер першого покоління",   category: "category-1" },

    { id: "categ21",  label: "Брандмауер другого покоління",   category: "category-2" },

    { id: "categ31",  label: "Брандмауер третього покоління",   category: "category-3" },
  ];
