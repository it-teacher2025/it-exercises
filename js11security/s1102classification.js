...
const itemsData = [
    { id: "categ11",  label: "Перехоплення інформації",   category: "category-1" },

    { id: "categ21",  label: "Модифікація інформації",   category: "category-2" },

    { id: "categ32",  label: "Підміна авторства інформації",   category: "category-3" },
  ];
