...
const itemsData = [
    { id: "categ11",  label: "зловмисні",   category: "category-1" },
    { id: "categ12",  label: "випадкові",   category: "category-1" },

    { id: "categ21",  label: "зовнішні",   category: "category-2" },
    { id: "categ22",  label: "внутрішні",   category: "category-2" },

    { id: "categ31",  label: "природні",   category: "category-3" },
    { id: "categ32",  label: "техногенні",   category: "category-3" },
    { id: "categ33",  label: "зумовлені людиною",   category: "category-3" },
  ];
