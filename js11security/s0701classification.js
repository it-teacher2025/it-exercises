...
const itemsData = [
    { id: "categ11",  label: "Законодавчі",   category: "category-1" },
    { id: "categ12",  label: "Фізичні (інженерні)",   category: "category-1" },
    { id: "categ13",  label: "Адміністративні",   category: "category-1" },

    { id: "categ21",  label: "Апаратні",   category: "category-2" },
    { id: "categ22",  label: "Програмні",   category: "category-2" },
    { id: "categ23",  label: "Криптографічні",   category: "category-2" },
  ];
