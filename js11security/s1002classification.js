...
const itemsData = [
    { id: "categ11",  label: "Шифрування",   category: "category-1" },
    { id: "categ12",  label: "Цифровий підпис",   category: "category-1" },
    { id: "categ13",  label: "Цілісність даних",   category: "category-1" },
    { id: "categ14",  label: "Аутентифікація",   category: "category-1" },
    { id: "categ15",  label: "Заповнення трафіку",   category: "category-1" },
    { id: "categ16",  label: "Нотарізація",   category: "category-1" },

    { id: "categ21",  label: "Мітки безпеки",   category: "category-2" },
    { id: "categ22",  label: "Виявлення подій",   category: "category-2" },
    { id: "categ23",  label: "Контроль безпеки",   category: "category-2" },
    { id: "categ24",  label: "Відновлення безпеки",   category: "category-2" },
    { id: "categ25",  label: "Довірча функціональність",   category: "category-2" },
  ];
