...
const itemsData = [
    { id: "categ11",  label: "Будуються на підставі одного принципу управління інформаційною безпекою.",   category: "category-1" },

    { id: "categ21",  label: "Будуються на основі декількох принципів управління інформаційною безпекою, кожний з яких слугує вирішенню власного завдання.",   category: "category-2" },

    { id: "categ31",  label: "Це багаторівневі технології, об’єднані у єдину систему координуючими функціями на організаційному рівні з метою забезпечення інформаційної безпеки, виходячи з аналізу сукупності чинників небезпеки, які мають семантичний зв’язок або генеруються з єдиного інформаційного центру інформаційного впливу.",   category: "category-3" },

    { id: "categ41",  label: "Це багаторівневі, багатокомпонентні технології, побудовані на підставі могутніх автоматизованих інтелектуальних засобів з організаційним управлінням.",   category: "category-4" },
  ];
