...
const itemsData = [
    { id: "categ11",  label: "Забезпечення доступу до загальнодоступних даних усім користувачам, захист цих даних від спотворення та блокування зловмисниками.",   category: "category-1" },

    { id: "categ21",  label: "Забезпечення доступу до даних на основі розподілу прав доступу.",   category: "category-2" },

    { id: "categ31",  label: "Захист даних від зловмисного або випадкового видалення чи спотворення.",   category: "category-3" },
  ];
