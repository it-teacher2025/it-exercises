/**
   ...
   */
const steps = [
    { text: `<img src="../img/img-class10-graphica/gr01-4.webp" alt="Наскельні малюнки" draggable="false" width="240px">`, correctIndex: 0 },
    { text: `<img src="../img/img-class10-graphica/gr01-5.webp" alt="Книга Русі" draggable="false" width="240px">`, correctIndex: 1 },
    { text: `<img src="../img/img-class10-graphica/gr01-6.webp" alt="Комп'ютерна графіка" draggable="false" width="240px">`, correctIndex: 2 },
  ];
