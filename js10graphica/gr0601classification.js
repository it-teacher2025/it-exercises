...
const itemsData = [
    { id: "categ11",  label: "Панель інструментів, під нею - кнопки налаштування кольорів і вікно налаштування параметрів обраного інструмента.",   category: "category-1" },

    { id: "categ21",  label: "Область діалогу: шари, канали, контури та історія під нею - вікно відображення шарів.",   category: "category-2" },

    { id: "categ31",  label: "Панелі «Пензель/Текстури/Градієнт», що показують діалоги налаштування пензля, текстур, градієнта.",   category: "category-3" },

    { id: "categ41",  label: "Типи пензлів.",   category: "category-4" },
  ];
