...
const itemsData = [
    { id: "categ11",  label: "Паперові буклети",   category: "category-1" },
    { id: "categ12",  label: "Книги",   category: "category-1" },
    { id: "categ13",  label: "Каталоги",   category: "category-1" },
    { id: "categ14",  label: "Візитні картки",   category: "category-1" },

    { id: "categ21",  label: "реклама на щитах-білбордах",   category: "category-2" },

    { id: "categ31",  label: "Відеоролики",   category: "category-3" },
    { id: "categ32",  label: "Радіоповідомлення",   category: "category-3" },
    { id: "categ33",  label: "Періодичні друковані видання",   category: "category-3" },
  ];
