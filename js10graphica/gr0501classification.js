const itemsData = [
  {
    id: "rgb_item",
    label: `<p>RGB</p><img 
              src="../img/img-class10-graphica/100rgb.webp" 
              alt="RGB diagram"
              draggable="false"
              width="120px"
            >`,
  ...
  },
  {
    id: "cmyk_item",
    label: `<p>CMYK</p><img 
              src="../img/img-class10-graphica/100cmyk.webp" 
              alt="CMYK diagram"
              draggable="false"
              width="120px"
            >`,
  ...
  },
  {
    id: "lab_item",
    label: `<p>Lab</p><img 
              src="../img/img-class10-graphica/100lab.webp" 
              alt="LAB diagram"
              draggable="false"
              width="120px"
            >`,
  ...
  },
  {
    id: "hsv_item",
    label: `<p>HSV</p><img 
              src="../img/img-class10-graphica/100hsv.webp" 
              alt="HSV diagram"
              draggable="false"
              width="120px"
            >`,
